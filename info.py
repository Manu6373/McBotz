...
API_ID = int(environ.get('API_ID', '24060956'))
API_HASH = environ.get('API_HASH', '2c51488ca0ef1b542ebc7c55e72f3b5e')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1408101293').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002603645635'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002656915704').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002665673608') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002665673608')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/McMoviesKA')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/McMoviesKA')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'McChatz_bot') # Support Chat Link Without https:// or @
